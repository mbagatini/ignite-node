...
- Manter cadastro de variações do produto (cor, tamanho)
- Rastrear movimentações de estoque de um produto pelo seu id e variação
- Definir quantidade mínima de estoque do produto
- Alertar sobre estoque mínimo por email e por notificação no sistema
- Histórico de vendas com filtro por período
- Historico de estoque
- Grafico de tendencia de estoque
- Integração com fornecedores para bter atualizações sobre prazos de entrega de ordens de compra
